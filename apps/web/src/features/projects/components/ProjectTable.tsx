        ...
        <div key={group.managerName}>
          <div className="mb-3 flex items-center px-1">
            <h3 className="text-sm font-bold uppercase tracking-wider text-foreground">
              Gestor(a): {group.managerName}
            </h3>
            <span className="ml-3 flex items-center justify-center rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-semibold text-primary">
              ...
              <tbody>
                {group.projects.map((project) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-muted-foreground">{project.scope}</td>
